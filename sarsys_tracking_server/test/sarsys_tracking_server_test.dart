...
Future main() async {
  ...
  test('GRPC GetMetaRequest returns GetMetaResponse with default values', () async {
    ...
    expect(response.trackings.lastEvent.timestamp.toInt(), 0);
    ...
    expect(response.positions.lastEvent.timestamp.toInt(), 0);
    ...
    expect(response.repo.lastEvent.timestamp.toInt(), 0);
