...
PositionModel _$PositionModelFromJson(Map<String, dynamic> json) {
  return PositionModel(
      geometry: json['geometry'] == null ? null : PointModel.fromJson(json['geometry'] as Map<String, dynamic>),
      properties:
          json['properties'] == null ? null : PositionModelProps.fromJson(json['properties'] as Map<String, dynamic>));
}

Map<String, dynamic> _$PositionModelToJson(PositionModel instance) =>
    <String, dynamic>{'geometry': instance.geometry?.toJson(), 'properties': instance.properties?.toJson()};
...
Map<String, dynamic> _$PositionModelPropsToJson(PositionModelProps instance) => <String, dynamic>{
