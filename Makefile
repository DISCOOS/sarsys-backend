...
document:
	...
	aqueduct document \
		--title SarSys App Server API
		--description API consumed by SarSys App \
		--api-version v1 \
		--contact-email support@discoos.org \
		--contact-url https://discoos.org \
		--host=https://sarsys.app > web/sarsys.json
	echo "[✓] Generate OpenAPI document"
